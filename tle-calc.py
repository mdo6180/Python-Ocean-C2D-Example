...
# stations_url = 'https://www.celestrak.com/NORAD/elements/iridium.txt'
...
def generate_csv(sat, time, eol_index, us_inc, num_samples, data):
    ...
    for i in range(num_samples):
        ...
        print(datestamp)
        print(datestamp + position_string)

        with open("iridium.json", "w") as file:
            obj = {
                "time": datestamp,
...
def main():
    #url = input("Enter TLE url: ")
    url = "https://www.celestrak.com/NORAD/elements/iridium.txt"
    ...
    try:
        #num_samples = int(input("Enter total number of samples: "))
        num_samples = 1
    except:
        print("  \033[31mUnable to parse value\033[0m")
        exit(1)
